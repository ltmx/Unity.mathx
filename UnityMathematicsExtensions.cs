...
public static class UnityMathematicsExtensions
{
    ...
    public static Complex gamma(this Complex z)
    {
        // Reflection formula
        if (z.Real < 0.5) return math.PI_DBL / (Complex.Sin( math.PI_DBL * z) * gamma(1 - z));
    ...
    public static float gamma(this float f)
    {
        if (f < 0.5) return (float)(math.PI_DBL / ((math.PI_DBL * f).sin() * gamma(1 - f)));
        ...
        var t = f2 + 7.5;
        return (float)((2 * math.PI_DBL).sqrt() * t.pow(f2 + 0.5) * (-t).exp() * x);
    }

    public static double gamma(this double f)
    {
        if (f < 0.5) return math.PI_DBL / ((math.PI_DBL * f).sin() * gamma(1 - f));
    ...
    public static double4 clamp(this double4 f, double min, double max) => math.clamp(f, min, max);
    public static double3 clamp(this double3 f, double min, double max) => math.clamp(f, min, max);
    public static double2 clamp(this double2 f, double min, double max) => math.clamp(f, min, max);
    ...
    public static double4 min(this double4 f, double min) => math.min(f, min);
    public static double3 min(this double3 f, double min) => math.min(f, min);
    public static double2 min(this double2 f, double min) => math.min(f, min);
    ...
    public static double4 max(this double4 f, double min) => math.max(f, min);
    public static double3 max(this double3 f, double min) => math.max(f, min);
    public static double2 max(this double2 f, double min) => math.max(f, min);

    // Component Wise Maximums
    public static float4 max(this float4 f, float4 min) => math.max(f, min);
    public static float3 max(this float3 f, float3 min) => math.max(f, min);
    public static float2 max(this float2 f, float2 min) => math.max(f, min);
    public static int max(this int f, int min) => math.max(f, min);
    
    public static double4 max(this double4 f, double4 min) => math.max(f, min);
    public static double3 max(this double3 f, double3 min) => math.max(f, min);
    public static double2 max(this double2 f, double2 min) => math.max(f, min);
    public static double max(this double f, double min) => math.max(f, min);
    ...
    public static double4 pow(this double4 f, double min) => math.max(f, min);
    public static double3 pow(this double3 f, double min) => math.max(f, min);
    public static double2 pow(this double2 f, double min) => math.max(f, min);
    ...
    /// Interpolate smoothly between min and max based on the input value 
    public static double4 smoothstep(this double4 f, double min, double max) {
        var a = ((f - min) / (max - min)).saturate();
        return a * a * (3 - 2 * a);
    }
    /// Interpolate smoothly between min and max based on the input value 
    public static double3 smoothstep(this double3 f, double min, double max) {
        var a = ((f - min) / (max - min)).saturate();
        return a * a * (3 - 2 * a);
    }
    /// Interpolate smoothly between min and max based on the input value 
    public static double2 smoothstep(this double2 f, double min, double max) {
        var a = ((f - min) / (max - min)).saturate();
        return a * a * (3 - 2 * a);
    }
    /// Interpolate smoothly between min and max based on the input value 
    public static double smoothstep(this double f, double min, double max) {
        var a = ((f - min) / (max - min)).saturate();
        return a * a * (3 - 2 * a);
    }
    ...
    public static double4 cmax(this double4 f) => math.cmax(f);
    public static double3 cmax(this double3 f) => math.cmax(f);
    public static double2 cmax(this double2 f) => math.cmax(f);
    ...
    public static double4 cmin(this double4 f) => math.cmin(f);
    public static double3 cmin(this double3 f) => math.cmin(f);
    public static double2 cmin(this double2 f) => math.cmin(f);
    ...
    public static double4 asfloat(this float4 f) => f;
    public static double3 asfloat(this float3 f) => f;
    public static double2 asfloat(this float2 f) => f;
    public static double asfloat(this float f) => f;
