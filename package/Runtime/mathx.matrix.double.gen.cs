...
namespace Unity.Mathematics
{
	public static partial class mathx
	{
		...
		[MI(IL)] public static double4x4 d4x4(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21, double m22, double m23, double m30,
			double m31, double m32, double m33) => new(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33);
		...
		[MI(IL)] public static double4x2 d4x2(double m00, double m01, double m10, double m11, double m20, double m21, double m30, double m31) => new(m00, m01, m10, m11, m20, m21, m30, m31);
		...
		[MI(IL)] public static double3x2 d3x2(double m00, double m01, double m10, double m11, double m20, double m21) => new(m00, m01, m10, m11, m20, m21);

		/// <inheritdoc cref="math.double2x4(double, double, double, double, double, double, double, double)"/>
		[MI(IL)] public static double2x4 d2x4(double m00, double m01, double m10, double m11, double m20, double m21, double m30, double m31) => new(m00, m01, m10, m11, m20, m21, m30, m31);

		/// <inheritdoc cref="math.double2x3(double, double, double, double, double, double)"/>
		[MI(IL)] public static double2x3 d2x3(double m00, double m01, double m10, double m11, double m20, double m21) => new(m00, m01, m10, m11, m20, m21);

		/// <inheritdoc cref="math.double2x2(double, double, double, double)"/>
		[MI(IL)] public static double2x2 d2x2(double m00, double m01, double m10, double m11) => new(m00, m01, m10, m11);
