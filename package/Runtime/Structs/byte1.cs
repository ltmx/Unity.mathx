...
namespace Unity.Mathematics
{
	...
	public struct byte1 : IEquatable<byte1>, IEquatable<byte>, IFormattable
	{
		...
		// Constructors
		[MI(IL)] public byte1(byte1 x)
		{
			value = x.value;
		}
		[MI(IL)] public byte1(byte x)
		{
			value = x;
		}
		[MI(IL)] public byte1(int x)
		{
			value = (byte)x;
		}
		[MI(IL)] public byte1(float v)
		{
			value = (byte)v;
		}
		[MI(IL)] public byte1(double v)
		{
			value = (byte)v;
		}
		...
		[MI(IL)] public bool Equals(byte1 b) => value == b.value;
