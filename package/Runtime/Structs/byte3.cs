...
namespace Unity.Mathematics
{
	...
	public struct byte3 : IEquatable<byte3>, IFormattable
	{
		...
		[MethodImpl(IL)] public byte3(byte x, byte y, byte z)
		{
			this.x = x;
			this.y = y;
			this.z = z;
		}
		[MethodImpl(IL)] public byte3(ValueType x, ValueType y, ValueType z)
		{
			this.x = (byte)x;
			this.y = (byte)y;
			this.z = (byte)z;
		...
		[MethodImpl(IL)] public byte3(byte x, byte2 yz)
		{
			this.x = x;
			y      = yz.x;
			z      = yz.y;
		...
		[MethodImpl(IL)] public byte3(byte2 xy, byte z)
		{
			x      = xy.x;
			y      = xy.y;
			this.z = z;
		...
		[MethodImpl(IL)] public byte3(uint3 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
			z = (byte)v.z;
		...
		[MethodImpl(IL)] public byte3(int3 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
			z = (byte)v.z;
		...
		[MethodImpl(IL)] public byte3(double3 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
			z = (byte)v.z;
