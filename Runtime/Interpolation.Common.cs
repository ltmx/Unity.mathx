...
namespace Unity.Mathematics
{
    ...
    public static partial class mathx
    {
        ...
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        [MethodImpl(IL)] public static  float4 smoothstep(this Vector4 f, float4 min, float4 max) => math.smoothstep(min, max, f);
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        [MethodImpl(IL)] public static  float3 smoothstep(this Vector3 f, float3 min, float3 max) => math.smoothstep(min, max, f);
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        [MethodImpl(IL)] public static  float2 smoothstep(this Vector2 f, float2 min, float2 max) => math.smoothstep(min, max, f);
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        ...
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        [MethodImpl(IL)] public static  float4 smoothstep(this Vector4 f) => f.smoothstep(0, 1);
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        [MethodImpl(IL)] public static  float3 smoothstep(this Vector3 f) => f.smoothstep(0, 1);
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        [MethodImpl(IL)] public static  float2 smoothstep(this Vector2 f) => f.smoothstep(0, 1);
        /// <inheritdoc cref="smoothstep(float,float,float)" />
        ...
        /// <inheritdoc cref="unlerp(float,float,float)" />
        [MethodImpl(IL)] public static  float4 unlerp(this Vector4 f, float4 min, float4 max) => math.unlerp(min, max, f);
        /// <inheritdoc cref="unlerp(float,float,float)" />
        [MethodImpl(IL)] public static  float3 unlerp(this Vector3 f, float3 min, float3 max) => math.unlerp(min, max, f);
        /// <inheritdoc cref="unlerp(float,float,float)" />
        [MethodImpl(IL)] public static  float2 unlerp(this Vector2 f, float2 min, float2 max) => math.unlerp(min, max, f);
        /// <inheritdoc cref="unlerp(float,float,float)" />
        ...
        /// <inheritdoc cref="step(float,float)" />
        [MethodImpl(IL)] public static  float4 step(this Vector4 f, float4 step) => math.step(f, step);
        /// <inheritdoc cref="step(float,float)" />
        [MethodImpl(IL)] public static  float3 step(this Vector3 f, float3 step) => math.step(f, step);
        /// <inheritdoc cref="step(float,float)" />
        [MethodImpl(IL)] public static  float2 step(this Vector2 f, float2 step) => math.step(f, step);
        /// <inheritdoc cref="step(float,float)" />
