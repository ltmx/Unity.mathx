...
namespace Unity.Mathematics
{
	public static partial class mathx
	{
		...
		const double THIRD_DBL = 0.333333333333333333333;
		/// 1/3
		const float THIRD = 0.3333333333f;
		...
		static readonly int[] POWERS_OF_2 = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1048576};
		// Utility Constants ----------------------------------------------------
