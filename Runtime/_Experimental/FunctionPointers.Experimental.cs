...
namespace Unity.Mathematics
{
    public class FunctionPointers_Experimental
    {
        ...
        // public delegate float process2f2(float2 t1, float2 t2);
        // public delegate float process3f2(float2 t1, float2 t2, float2 t3);
        // public delegate float process4f2(float2 t1, float2 t2, float2 t3, float2 t4);
        ...
        // [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        // public delegate float2 process3SignatureFloat2(FunctionPointer<process3f2> fp,float2 t1, float2 t2, float2 t3);
        
        // // Parallel operations With Pointer Compilation // Deprecated (slower)
        // public static float4 InvokeParallel(process2 func, float4 a, float4 b) => ToPointerInvoke(func).Parallel(a, b);
        // public static float3 InvokeParallel(process2 func, float3 a, float3 b) => ToPointerInvoke(func).Parallel(a, b);
        // public static float2 InvokeParallel(process2 func, float2 a, float2 b) => ToPointerInvoke(func).Parallel(a, b);
        ...
        // public static float4 ParallelAndParam(this process3 func, float4 a, float4 b, float t) => ToPointerInvoke(func).ParallelAndParam(a, b, t);
        // public static float3 ParallelAndParam(this process3 func, float3 a, float3 b, float t) => ToPointerInvoke(func).ParallelAndParam(a, b, t);
        // public static float2 ParallelAndParam(this process3 func, float2 a, float2 b, float t) => ToPointerInvoke(func).ParallelAndParam(a, b, t);
        ...
        // public static float4 ParallelAndParam(this process3 func, float4 a, float4 b, float4 t) => ToPointerInvoke(func).ParallelAndParam(a, b, t);
        // public static float3 ParallelAndParam(this process3 func, float3 a, float3 b, float3 t) => ToPointerInvoke(func).ParallelAndParam(a, b, t);
        // public static float2 InvokeParallelAndParam(this process3 func, float2 a, float2 b, float2 t) => ToPointerInvoke(func).ParallelAndParam(a, b, t);
