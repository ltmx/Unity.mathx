...
namespace Unity.Mathematics
{
    public static partial class mathx
    {
        ...
        public static float4 ParallelAndParam(this FunctionPointer<process3<float>> func, float4 a, float4 b, float t) => new(func.Invoke(a.x, b.x, t), func.Invoke(a.y, b.y, t), func.Invoke(a.z, b.z, t), func.Invoke(a.w, b.w, t));
        public static float3 ParallelAndParam(this FunctionPointer<process3<float>> func, float3 a, float3 b, float t) => new(func.Invoke(a.x, b.x, t), func.Invoke(a.y, b.y, t), func.Invoke(a.z, b.z, t));
        public static float2 ParallelAndParam(this FunctionPointer<process3<float>> func, float2 a, float2 b, float t) => new(func.Invoke(a.x, b.x, t), func.Invoke(a.y, b.y, t));
        public static float ParallelAndParam(this FunctionPointer<process3<float>> func, float a, float b, float t) => func.Invoke(a, b, t);
        public static float4 ParallelAndParam(this FunctionPointer<process3<float>> func, float4 a, float4 b, float4 t) => new(func.Invoke(a.x, b.x, t.x), func.Invoke(a.y, b.y, t.y), func.Invoke(a.z, b.z, t.z), func.Invoke(a.w, b.w, t.w));
        public static float3 ParallelAndParam(this FunctionPointer<process3<float>> func, float3 a, float3 b, float3 t) => new(func.Invoke(a.x, b.x, t.x), func.Invoke(a.y, b.y, t.y), func.Invoke(a.z, b.z, t.z));
        public static float2 ParallelAndParam(this FunctionPointer<process3<float>> func, float2 a, float2 b, float2 t) => new(func.Invoke(a.x, b.x, t.x), func.Invoke(a.y, b.y, t.y));
        
        // Parallel operations and float parameter With Pointer Compilation
        public static float4 ParallelAndParam(this process3<float> func, float4 a, float4 b, float t) => ToPointer(func).ParallelAndParam(a, b, t);
        public static float3 ParallelAndParam(this process3<float> func, float3 a, float3 b, float t) => ToPointer(func).ParallelAndParam(a, b, t);
        public static float2 ParallelAndParam(this process3<float> func, float2 a, float2 b, float t) => ToPointer(func).ParallelAndParam(a, b, t);
        public static float ParallelAndParam(this process3<float> func, float a, float b, float t) => ToPointer(func).ParallelAndParam(a, b, t);
        public static float4 ParallelAndParam(this process3<float> func, float4 a, float4 b, float4 t) => ToPointer(func).ParallelAndParam(a, b, t);
        public static float3 ParallelAndParam(this process3<float> func, float3 a, float3 b, float3 t) => ToPointer(func).ParallelAndParam(a, b, t);
        public static float2 ParallelAndParam(this process3<float> func, float2 a, float2 b, float2 t) => ToPointer(func).ParallelAndParam(a, b, t);
