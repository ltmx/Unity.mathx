...
namespace Unity.Mathematics
{
	...
	public class MyPropertyDescriptor : PropertyDescriptor
	{
		...
		public MyPropertyDescriptor(PropertyDescriptor originalProperty) : base(originalProperty)
		{
		...
		public override AttributeCollection Attributes
		{
			get
			{
				IEnumerable<Attribute> attributes = base.Attributes.Cast<Attribute>();
				var result = new List<Attribute>();
				foreach(Attribute item in attributes)
					if (item is IMetadataAttribute attribute)
					{
						Attribute[] attrs = attribute.Process();
	...
	public class MyTypeDescriptor : CustomTypeDescriptor
	{
		...
		public MyTypeDescriptor(ICustomTypeDescriptor originalDescriptor) : base(originalDescriptor)
		{
		...
		{
			MyPropertyDescriptor[] properties = base.GetProperties(attributes).Cast<PropertyDescriptor>().Select(p => new MyPropertyDescriptor(p)).ToArray();
	...
	public class MySampleClass
	{
		...
		// [MySampleMetadata] 
		[DisplayName("My Name")] public string Name { get; set; }
	}
}