...
//         }
    ...
    public static color HSVToRGB(float H, float S, float V, bool hdr)
    {
      ...
      return white;
        ...
        public float grayscale => dot(new float3(0.29899999499321f, 0.587000012397766f, 57 / 500), xyz);
    ...
    public static partial class UME
    {
        ...
        public static uint hash(color v){
            return csum(asuint(v) * new uint4(0xE69626FFu, 0xBD010EEBu, 0x9CEDE1D1u, 0x43BE0B51u)) + 0xAF836EE1u;
        }
        ...
        public static uint4 hashwide(color v) {
            return (asuint(v) * new uint4(0xB130C137u, 0x54834775u, 0x7C022221u, 0xA2D00EDFu)) + 0xA8977779u;
        }

        /// <summary>Returns the result of specified shuffling of the components from two color vectors into a float value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float shuffle(color a, color b, ShuffleComponent x) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static color shuffle(color a, color b, ShuffleComponent x, ShuffleComponent y, ShuffleComponent z, ShuffleComponent w){
            return color(
                select_shuffle_component(a, b, x),
                select_shuffle_component(a, b, y),
                select_shuffle_component(a, b, z),
        ...
        public static float sum(this color f) => csum(f);
