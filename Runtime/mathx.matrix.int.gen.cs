...
namespace Unity.Mathematics
{
	public static partial class mathx
	{
		...
		[MI(IL)] public static int4x2 i4x2(int m00, int m01, int m10, int m11, int m20, int m21, int m30, int m31) => new(m00, m01, m10, m11, m20, m21, m30, m31);
		...
		[MI(IL)] public static int3x3 i3x3(int m00, int m01, int m02, int m10, int m11, int m12, int m20, int m21, int m22) => new(m00, m01, m02, m10, m11, m12, m20, m21, m22);

		/// <inheritdoc cref="math.int3x2(int, int, int, int, int, int)"/>
		[MI(IL)] public static int3x2 i3x2(int m00, int m01, int m10, int m11, int m20, int m21) => new(m00, m01, m10, m11, m20, m21);

		/// <inheritdoc cref="math.int2x4(int, int, int, int, int, int, int, int)"/>
		[MI(IL)] public static int2x4 i2x4(int m00, int m01, int m10, int m11, int m20, int m21, int m30, int m31) => new(m00, m01, m10, m11, m20, m21, m30, m31);

		/// <inheritdoc cref="math.int2x3(int, int, int, int, int, int)"/>
		[MI(IL)] public static int2x3 i2x3(int m00, int m01, int m10, int m11, int m20, int m21) => new(m00, m01, m10, m11, m20, m21);

		/// <inheritdoc cref="math.int2x2(int, int, int, int)"/>
		[MI(IL)] public static int2x2 i2x2(int m00, int m01, int m10, int m11) => new(m00, m01, m10, m11);
