...
namespace Unity.Mathematics
{
    public static partial class mathx
    {
        ...
        [MethodImpl(IL)] public static float3x4 inverse(this float3x4 m) => float3x4(m.rotationMatrix(), m[3].rotate(-m.rotationMatrix()));
        ...
        [MethodImpl(IL)] public static float3x3 rotationMatrix(this float3x4 m) => m.f3x3();
        /// Returns the rotation component of a float4x3 matrix
        [MethodImpl(IL)] public static float3x3 rotationMatrix(this float4x3 m) => m.f3x3();
        /// Returns the rotation component of a float4x4 matrix
        [MethodImpl(IL)] public static float3x3 rotationMatrix(this float4x4 m) => m.f3x3();
        /// Returns the rotation component of a float4x3 matrix
        [MethodImpl(IL)] public static float3 translationMatrix(this float4x3 m) => m[3].xyz;
        /// Returns the rotation component of a float4x4 matrix
        [MethodImpl(IL)] public static float3 translationMatrix(this float4x4 m) => m[3].xyz;
        /// Returns the translation component of a float3x4 matrix
        [MethodImpl(IL)] public static float3 translationMatrix(this float3x4 m) => m[3];
