...
namespace Unity.Mathematics
{
    ...
    public struct color : IEquatable<color>, IFormattable
    {
        ...
        [MethodImpl(INLINE)]
        public static implicit operator color(float v) => new(v);
        ...
        /// </summary>
        [MethodImpl(INLINE)]
        public static explicit operator color(bool v) => new(v);

        /// <summary>Explicitly converts a bool4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static explicit operator color(bool4 v) => new(v);
        ...
        /// </summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(int v) => new(v);

        /// <summary>Implicitly converts a int4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(int4 v) => new(v);
        ...
        /// </summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(uint v) => new(v);

        /// <summary>Implicitly converts a uint4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(uint4 v) => new(v);
        ...
        /// </summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(half v) => new(v);

        /// <summary>Implicitly converts a half4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(half4 v) => new(v);
        ...
        /// </summary>
        [MethodImpl(INLINE)]
        public static explicit operator color(double v) => new(v);

        /// <summary>Explicitly converts a double4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static explicit operator color(double4 v) => new(v);

        /// <summary>Explicitly converts a double4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(float4 v) => new(v);

        /// <summary>Explicitly converts a double4 vector to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator color(float3 v) => new(v);

        // Additions --------------------------------------------------------------

        /// <summary>Implicitly converts a color vector to a float4 by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator float4(color v) => new(v.x, v.y, v.z, v.w);

        /// <summary>Explicitly converts a color vector to a float3 by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static explicit operator float3(color v) => new(v.x, v.y, v.z);

        /// <summary>Explicitly converts a color to a UnityEngine.Color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static implicit operator Color(color b) => new(b.x, b.y, b.z, b.w);
        ...
        [MethodImpl(INLINE)]
        public static explicit operator Vector4(color c) => new(c.x, c.y, c.z, c.w);
        ...
        [MethodImpl(INLINE)]
        public static explicit operator Vector3(color c) => new(c.x, c.y, c.z);

        /// <summary>Explicitly converts a Vector3 to a color by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static explicit operator color(Vector3 v) => new(v.x, v.y, v.z, 1);
        ...
        [MethodImpl(INLINE)]
        public static color operator *(color lhs, float rhs) => new(lhs.x * rhs, lhs.y * rhs, lhs.z * rhs, lhs.w * rhs);

        /// <summary>Returns the result of a componentwise multiplication operation on a float value and a color vector.</summary>
        [MethodImpl(INLINE)]
        public static color operator *(float lhs, color rhs) => new(lhs * rhs.x, lhs * rhs.y, lhs * rhs.z, lhs * rhs.w);
        ...
        [MethodImpl(INLINE)]
        public static color operator ++(color val) => new(++val.x, ++val.y, ++val.z, ++val.w);
        ...
        [MethodImpl(INLINE)]
        public static bool4 operator <(color lhs, color rhs) =>
            new(lhs.x < rhs.x, lhs.y < rhs.y, lhs.z < rhs.z, lhs.w < rhs.w);

        /// <summary>Returns the result of a componentwise less than operation on a color vector and a float value.</summary>
        [MethodImpl(INLINE)]
        public static bool4 operator <(color lhs, float rhs) => new(lhs.x < rhs, lhs.y < rhs, lhs.z < rhs, lhs.w < rhs);

        /// <summary>Returns the result of a componentwise less than operation on a float value and a color vector.</summary>
        [MethodImpl(INLINE)]
        public static bool4 operator <(float lhs, color rhs) => new(lhs < rhs.x, lhs < rhs.y, lhs < rhs.z, lhs < rhs.w);
        ...
        [MethodImpl(INLINE)]
        public static bool4 operator <=(color lhs, float rhs) =>
        ...
        [MethodImpl(INLINE)]
        public static bool4 operator <=(float lhs, color rhs) =>
...
//         }
        ...
        public static void RGBToHSV(color rgbColor, out float H, out float S, out float V)
        {
            if (rgbColor.z > rgbColor.y && rgbColor.z > rgbColor.x)
                ...
                RGBToHSVHelper(0, rgbColor.x, rgbColor.y, rgbColor.z, out H, out S, out V);
        }
        ...
        [MethodImpl(INLINE)]
        public bool Equals(color rhs) => x == rhs.x && y == rhs.y && z == rhs.z && w == rhs.w;
        ...
        public float grayscale => dot(float3(0.29899999499321f, 0.587000012397766f, 57 / 500f), xyz);
    ...
    public static partial class Math
    {
        ...
        [MethodImpl(INLINE)]
        public static color color(float x, float y, float z, float w) => new(x, y, z, w);

        /// <summary>Returns a color vector constructed from two float values and a float2 vector.</summary>
        [MethodImpl(INLINE)]
        public static color color(float x, float y, float2 zw) => new(x, y, zw);

        /// <summary>Returns a color vector constructed from a float value, a float2 vector and a float value.</summary>
        [MethodImpl(INLINE)]
        public static color color(float x, float2 yz, float w) => new(x, yz, w);

        /// <summary>Returns a color vector constructed from a float value and a float3 vector.</summary>
        [MethodImpl(INLINE)]
        public static color color(float x, float3 yzw) => new(x, yzw);

        /// <summary>Returns a color vector constructed from a float2 vector and two float values.</summary>
        [MethodImpl(INLINE)]
        public static color color(float2 xy, float z, float w) => new(xy, z, w);

        /// <summary>Returns a color vector constructed from two float2 vectors.</summary>
        [MethodImpl(INLINE)]
        public static color color(float2 xy, float2 zw) => new(xy, zw);

        /// <summary>Returns a color vector constructed from a float3 vector and a float value.</summary>
        [MethodImpl(INLINE)]
        public static color color(float3 xyz, float w) => new(xyz, w);

        /// <summary>Returns a color vector constructed from a color vector.</summary>
        [MethodImpl(INLINE)]
        public static color color(color xyzw) => new(xyzw);

        /// <summary>Returns a color vector constructed from a single float value by assigning it to every component.</summary>
        [MethodImpl(INLINE)]
        public static color color(float v) => new(v);

        /// <summary>
        ///     Returns a color vector constructed from a single bool value by converting it to float and assigning it to
        ///     every component.
        /// </summary>
        [MethodImpl(INLINE)]
        public static color color(bool v) => new(v);

        /// <summary>Return a color vector constructed from a bool4 vector by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static color color(bool4 v) => new(v);

        /// <summary>
        ///     Returns a color vector constructed from a single int value by converting it to float and assigning it to every
        ///     component.
        /// </summary>
        [MethodImpl(INLINE)]
        public static color color(int v) => new(v);

        /// <summary>Return a color vector constructed from a int4 vector by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static color color(int4 v) => new(v);

        /// <summary>
        ///     Returns a color vector constructed from a single uint value by converting it to float and assigning it to
        ///     every component.
        /// </summary>
        [MethodImpl(INLINE)]
        public static color color(uint v) => new(v);

        /// <summary>Return a color vector constructed from a uint4 vector by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static color color(uint4 v) => new(v);
        ...
        /// </summary>
        [MethodImpl(INLINE)]
        public static color color(half v) => new(v);

        /// <summary>Return a color vector constructed from a half4 vector by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static color color(half4 v) => new(v);

        /// <summary>
        ///     Returns a color vector constructed from a single double value by converting it to float and assigning it to
        ///     every component.
        /// </summary>
        [MethodImpl(INLINE)]
        public static color color(double v) => new(v);

        /// <summary>Return a color vector constructed from a double4 vector by componentwise conversion.</summary>
        [MethodImpl(INLINE)]
        public static color color(double4 v) => new(v);

        /// <summary>Returns a uint hash code of a color vector.</summary>
        [MethodImpl(INLINE)]
        public static uint hash(color v) =>
            csum(asuint(v) * new uint4(0xE69626FFu, 0xBD010EEBu, 0x9CEDE1D1u, 0x43BE0B51u)) + 0xAF836EE1u;
        ...
        public static uint4 hashwide(color v) =>
            asuint(v) * new uint4(0xB130C137u, 0x54834775u, 0x7C022221u, 0xA2D00EDFu) + 0xA8977779u;

        /// <summary>Returns the result of specified shuffling of the components from two color vectors into a float value.</summary>
        [MethodImpl(INLINE)]
        public static float shuffle(color a, color b, ShuffleComponent x) => select_shuffle_component(a, b, x);

        /// <summary>Returns the result of specified shuffling of the components from two color vectors into a float2 vector.</summary>
        [MethodImpl(INLINE)]
        public static float2 shuffle(color a, color b, ShuffleComponent x, ShuffleComponent y) =>
            float2(
        ...
        [MethodImpl(INLINE)]
        public static float3 shuffle(color a, color b, ShuffleComponent x, ShuffleComponent y, ShuffleComponent z) =>
            float3(
                select_shuffle_component(a, b, x),
                select_shuffle_component(a, b, y),
        ...
        [MethodImpl(INLINE)]
        public static color shuffle(color a, color b, ShuffleComponent x, ShuffleComponent y, ShuffleComponent z,
            ShuffleComponent w) =>
            color(
                select_shuffle_component(a, b, x),
                select_shuffle_component(a, b, y),
        ...
        [MethodImpl(INLINE)]
        internal static float select_shuffle_component(color a, color b, ShuffleComponent component)
        {
        ...
        [MethodImpl(INLINE)]
        public static color clamp(this color f, float min, float max) => new(f.x.clamp(min, max), f.y.clamp(min, max),
            f.z.clamp(min, max), f.w.clamp(min, max));

        [MethodImpl(INLINE)]
        public static color min(this color f, color m) => new(f.x.min(m.x), f.y.min(m.y), f.z.min(m.z), f.w.min(m.w));

        [MethodImpl(INLINE)]
        public static color max(this color f, color m) => new(f.x.max(m.x), f.y.max(m.y), f.z.max(m.z), f.w.max(m.w));

        [MethodImpl(INLINE)]
        public static color saturate(this color f) => new(saturate(f.x), saturate(f.y), saturate(f.z), saturate(f.w));

        [MethodImpl(INLINE)]
        public static color sqrt(this color f) => new(sqrt(f.x), sqrt(f.y), sqrt(f.z), sqrt(f.w));

        [MethodImpl(INLINE)]
        public static color pow(this color f, float p) => new(f.x.pow(p), f.y.pow(p), f.z.pow(p), f.w.pow(p));

        [MethodImpl(INLINE)]
        public static color pow(this color f, float4 p) => new(f.x.pow(p.x), f.y.pow(p.y), f.z.pow(p.z), f.w.pow(p.w));
        ...
        [MethodImpl(INLINE)]
        public static color pow4(this color f) => f.sq().sq();

        [MethodImpl(INLINE)]
        public static color pow5(this color f) => f.pow4() * f;

        [MethodImpl(INLINE)]
        public static color frac(this color f) => new(f.x.frac(), f.y.frac(), f.z.frac(), f.w.frac());

        [MethodImpl(INLINE)]
        public static color sign(this color f) => new(f.x.sign(), f.y.sign(), f.z.sign(), f.w.sign());

        [MethodImpl(INLINE)]
        public static color abs(this color f) => new(f.x.abs(), f.y.abs(), f.z.abs(), f.w.abs());

        [MethodImpl(INLINE)]
        public static float sum(this color f) => f.x + f.y + f.z + f.w;
        ...
        [MethodImpl(INLINE)]
        public static float gammatolinear(this float c) => c.pow(2.2f);
