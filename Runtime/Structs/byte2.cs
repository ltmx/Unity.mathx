...
namespace Unity.Mathematics
{
    ...
    public struct byte2 : IEquatable<byte2>, IFormattable
    {
        ...
        [MethodImpl(IL)] public byte2(byte x, byte y) { this.x = x; this.y = y; }
        
        [MethodImpl(IL)] public byte2(ValueType a, ValueType b)
        {
            x = (byte)a; 
            y = (byte)b;
        }
        ...
        [MethodImpl(IL)] public byte2(byte v) { x = y = v; }
        [MethodImpl(IL)] public byte2(ValueType v) { x = y = (byte)v; }
        
        ///Constructs a byte2 from a f2
        [MethodImpl(IL)] public byte2(float2 v) { x = (byte)v.x; y = (byte)v.y; }
        /// Constructs a byte2 from a int2
        [MethodImpl(IL)] public byte2(int2 v) { x = (byte)v.x; y = (byte)v.y; }
        /// Constructs a byte2 from a uint2
        [MethodImpl(IL)] public byte2(uint2 v) { x = (byte)v.x; y = (byte)v.y; }
        /// Constructs a byte2 from a half2
        [MethodImpl(IL)] public byte2(half2 v) { x = (byte)v.x; y = (byte)v.y; }
        /// Constructs a byte2 from a double2
        [MethodImpl(IL)] public byte2(double2 v) { x = (byte)v.x; y = (byte)v.y; }

        /// Implicitly converts a single byte value to a byte2 vector by assigning it to every component.
        [MethodImpl(IL)] public static implicit operator byte2(byte v) => new(v);
        /// Implicitly converts a single int value to a byte2 vector by assigning it to every component.
        [MethodImpl(IL)] public static implicit operator byte2(int v) => new((byte)v);
        /// Implicitly converts a single uint value to a byte2 vector by assigning it to every component.
        [MethodImpl(IL)] public static implicit operator byte2(uint v) => new((byte)v);
        /// Explicitly converts a single float value to a byte2 vector by assigning it to every component.
        [MethodImpl(IL)] public static explicit operator byte2(float v) => new((byte)v);
        /// Explicitly converts a single double value to a byte2 vector by assigning it to every component.
        [MethodImpl(IL)] public static explicit operator byte2(double v) => new((byte)v);
        
        /// Implicitly converts an int2 vector to a byte2 vector by componentwise conversion.
        [MethodImpl(IL)] public static implicit operator byte2(int2 v) => new(v);
        /// Implicitly converts an int2 vector to a byte2 vector by componentwise conversion.
        [MethodImpl(IL)] public static implicit operator byte2(uint2 v) => new(v);
        /// Explicitly converts a f2 vector to a byte2 vector by componentwise conversion.
        [MethodImpl(IL)] public static explicit operator byte2(float2 v) => new(v);
        /// Explicitly converts a double2 vector to a byte2 vector by componentwise conversion.
        [MethodImpl(IL)] public static explicit operator byte2(double2 v) => new(v);

        ///Returns the result of a componentwise equality operation on two byte2 vectors.
        [MethodImpl(IL)] public static bool2 operator ==(byte2 a, byte2 b) => new(a.x == b.x, a.y == b.y);
        ///Returns the result of a componentwise equality operation on a byte2 vector and a byte value.
        [MethodImpl(IL)] public static bool2 operator ==(byte2 a, byte b) => new(a.x == b, a.y == b);
        ///Returns the result of a componentwise equality operation on a byte value and a byte2 vector.
        [MethodImpl(IL)] public static bool2 operator ==(byte a, byte2 b) => new(a == b.x, a == b.y);
        ...
        [MethodImpl(IL)] public static int2 operator *(byte2 a, byte2 b) => new(a.x * b.x, a.y * b.y);
        ///Returns the result of a componentwise multiplication operation on a byte2 vector and a float value.
        [MethodImpl(IL)] public static int2 operator *(byte2 a, byte b) => new(a.x * b, a.y * b);
        ///Returns the result of a componentwise multiplication operation on a float value and a byte2 vector.
        [MethodImpl(IL)] public static int2 operator *(byte a, byte2 b) => new(a * b.x, a * b.y);
        ...
        [MethodImpl(IL)]public static byte2 operator ~(byte2 val) => new(~val.x, ~val.y);
        ...
        [MethodImpl(IL)] public static byte2 operator &(byte2 a, int b) => new(a.x & b, a.y & b);
        /// <summary>Returns the result of a componentwise bitwise and operation on an int value and an byte2 vector.</summary>
        [MethodImpl(IL)] public static byte2 operator &(int a, byte2 b) => new(a & b.x, a & b.y);
        ...
        [MethodImpl(IL)] public bool Equals(byte2 b) => x == b.x && y == b.y;
        ...
        [MethodImpl(IL)] public override string ToString() => $"byte2({x}, {y})";
        ...
        /// <returns>String representation of the value.</returns>
        [MethodImpl(IL)] public string ToString(string format, IFormatProvider formatProvider) => $"byte2({x.ToString(format, formatProvider)}, {y.ToString(format, formatProvider)})";
    ...
    public static partial class mathx
    {
        ...
        [MethodImpl(IL)] public static byte2 byte2(byte v) => new(v);
        ///Returns a byte2 vector constructed from a single byte value by assigning it to every component.
        [MethodImpl(IL)] public static byte2 byte2(ValueType v) => new(v);
        
        ///Returns a byte2 vector constructed from two byte values.
        [MethodImpl(IL)] public static byte2 byte2(byte x, byte y) => new(x, y);

        ///Return a byte2 vector constructed from a f2 vector by componentwise conversion.
        [MethodImpl(IL)] public static byte2 byte2(float2 v) => new(v);
        ///Return a byte2 vector constructed from a double2 vector by componentwise conversion.
        [MethodImpl(IL)] public static byte2 byte2(double2 v) => new(v);

        ///Returns a uint hash code of a byte2 vector.
        [MethodImpl(IL)] public static uint hash(byte2 v) => math.csum(uint2(v.x, v.y) * uint2(0x6E624EB7u, 0x7383ED49u)) + 0xDD49C23Bu;

        /// Returns a uint2 vector hash code of a byte2 vector.
        /// When multiple elements are to be hashes together, it can more efficient to calculate and combine wide hash
        /// that are only reduced to a narrow uint hash at the very end instead of at every step.
        [MethodImpl(IL)] public static uint2 hashwide(byte2 v) => uint2(v.x, v.y) * uint2(0xEBD0D005u, 0x91475DF7u) + 0x55E84827u;
