...
namespace Unity.Mathematics
{
	...
	public struct byte2 : IEquatable<byte2>, IFormattable
	{
		...
		[MethodImpl(IL)] public byte2(byte x, byte y)
		{
			this.x = x;
			this.y = y;
		}
		...
		[MethodImpl(IL)] public byte2(byte v)
		{
			x = y = v;
		}
		[MethodImpl(IL)] public byte2(ValueType v)
		{
			x = y = (byte)v;
		}

		///Constructs a byte2 from a f2
		[MethodImpl(IL)] public byte2(float2 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
		}
		/// Constructs a byte2 from a int2
		[MethodImpl(IL)] public byte2(int2 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
		}
		/// Constructs a byte2 from a uint2
		[MethodImpl(IL)] public byte2(uint2 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
		}
		/// Constructs a byte2 from a half2
		[MethodImpl(IL)] public byte2(half2 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
		}
		/// Constructs a byte2 from a double2
		[MethodImpl(IL)] public byte2(double2 v)
		{
			x = (byte)v.x;
			y = (byte)v.y;
		}
