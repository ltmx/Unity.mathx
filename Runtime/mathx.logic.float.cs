...
namespace Unity.Mathematics
{
    public static partial class mathx
    {
        ...
        /// <inheritdoc cref="math.isnan(Mathematics.float4)"/>
        ...
        /// <inheritdoc cref="greater(Mathematics.float4,float)"/>
        ...
        /// <inheritdoc cref="less(Mathematics.float4,float)"/>
        ...
        /// <inheritdoc cref="lesseq(Mathematics.float4,float)"/>
        ...
        /// <inheritdoc cref="greatereq(Mathematics.float4,float)"/>
        ...
        /// <inheritdoc cref="eq(Mathematics.float4,float)"/>
        ...
        /// <inheritdoc cref="neq(Mathematics.float4,float)"/>
