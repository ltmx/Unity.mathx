...
namespace Unity.Mathematics
{
    public static partial class mathx
    {
        ...
        [MethodImpl(IL)] public static quaternion quaternion(float3 eulerangles, RotationOrder rotationOrder = RotationOrder.Default) => Mathematics.quaternion.Euler(eulerangles, rotationOrder);
        
        //write a list in a comment, of all function names from the mathx class without specifying overloads, in alphabetical order, here :
        // abs acos 
    }
}